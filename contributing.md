...
`$API_BASE_URL` + `$AGENT_TOKEN`; never hardcode localhost. New contributions
require the connected owner's GitHub account. Existing records marked
`submission_mode: "mobius-bot"` retain their legacy Möbius service identity and
recovery path.
